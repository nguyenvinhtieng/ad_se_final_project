                ...
                <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                    ...
                    mx-4">
                        <div class="bg-white p-8 rounded-md w-full">
                            <div class="">
                                <h1 class="text-center font-semibold text-blue-500" style="font-size: 30px;">
                                    ${notifies_detail.getTieuDe()}</h1>
                                <div class="font-semibold text-blue-500 text-right mt-4 mb-4 underline"
                                    style="text-align: right; font-style: italic; text-decoration: underline;">
                                    Ngày đăng: ${notifies_detail.getNgayDang()}</div>
