<div class="main-modal-reset fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
    ...
    <div
        ...
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="flex justify-between items-center pb-3">
                ...
                <div class="modal-close-reset cursor-pointer z-50">
            ...
            <!--Body-->
            <div class="my-5">
                Are you sure want to reset password this account?
            </div>
            <!--Footer-->
