            ...
            <div
                ...
                <div class="modal-content py-4 text-left px-6">
                    ...
                    <div class="flex justify-between items-center pb-3">
                        <p class="text-2xl font-bold">Edit TKB</p>
                    ...
                    <div class="my-5">
                        <div class="mx-4">
                            <input type="hidden" name="thu" class="thu-edit">
                            <input type="hidden" name="tiet" class="tiet-edit">
                            <input type="hidden" name="buoi" class="buoi-edit">
                            ...
                            <select
                                ...
                                name="subject" v-model="form.email" autofocus>
                                <option value="">--Choose subject--</option>
                                <c:forEach items="${monhoc}" var="m">
                                    <option value="${m.getIdMonHoc()}">
                                        ${m.getTenMonHoc()}
                                    </option>
                                </c:forEach>
