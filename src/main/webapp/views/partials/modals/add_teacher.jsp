<form action="" method="POST" enctype="multipart/form-data">
    <div class="main-modal-create fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
        ...
        <div
            class="border border-teal-500 shadow-lg modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto m-y-2">
            <div class="modal-content py-4 text-left px-6">
                <!--Title-->
                <div class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-bold">Add new Teacher</p>
                ...
                <!--Body-->
                <div class="my-5 w-full flex gap-4">
                    <div class="mx-4 w-64">
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                name="id" v-model="form.email" required autofocus />
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-normal mb-2" for="name">
                                Name
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                name="avatar" v-model="form.email" required autofocus />
                        </div>
                    </div>
