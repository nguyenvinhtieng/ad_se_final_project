    ...
    <div
        ...
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="flex justify-between items-center pb-3">
                <p class="text-2xl font-bold">Delete Semester</p>
            ...
            <!--Body-->
            <div class="my-5">
                Are you sure want to delete this semester?
            </div>
            <!--Footer-->
            <div class="flex justify-end pt-2">
                ...
                <a href="#"
                    class="btn-delete focus:outline-none px-4 bg-red-500 p-2 ml-3 rounded-md text-white hover:bg-red-400">Delete</a>
            </div>
        </div>
    </div>
</div>