<form action="/admin/teachers/edit" method="POST" enctype="multipart/form-data">
        ...
        <div
            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-bold">Edit Teacher</p>
                ...
                <div class="my-5 flex gap-4">
                    <div class="mx-4 w-64">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-normal mb-2" for="identity">
                                Identity
                            </label>
                            <input
                                class="identity-edit shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                name="identity" v-model="form.email" required autofocus />
                        </div>
                        <div class="mb-4">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="email-edit shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
